...
function init_gear_sets()
    ...
    sets.idle.MasterDT = {
        ...
        hands = {
            ...
            augments = {"Accuracy+19 Attack+19", '"Triple Atk."+3', "STR+6", "Accuracy+13", "Attack+6"}
        },
    ...
    sets.idle.Pet.Engaged = {
        ...
        feet = {
            ...
            augments = {"Pet: Attack+30 Pet: Rng.Atk.+30", 'Pet: "Store TP"+9', 'Pet: "Mag.Atk.Bns."+15'}
        },
        neck = "Pup. Collar",
        waist = "Klouskap Sash +1",
