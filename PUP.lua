...
function user_setup()
    ...
    state.OffenseMode:options('MasterTP', 'MasterAcc', 'PetTP', 'PetDT')--PetAcc
    ...
    state.IdleMode:options('Idle', 'PetDT', 'MasterDT')
...
function init_gear_sets()
    ...
    sets.idle.PetDT = {main="Midnights",range="Animator P +1",ammo="Automat. Oil +3",
        ...
        body="Rao Togi",hands="Rao Kote",ring1="Overbearing Ring",ring2="Varar Ring",
	...
	sets.engaged.PetDT = {main="Midnights",range="Animator P +1",ammo="Automat. Oil +3",
        head="Rao Kabuto",neck="Empath Necklace",ear1="Handler's Earring +1",ear2="Enmerkar Earring",
        body="Rao Togi",hands="Rao Kote",ring1="Overbearing Ring",ring2="Varar Ring",
        back="Visucius's Mantle",waist="Isa Belt",legs="Tali'ah Sera. +1",feet="Rao Sune-Ate"
    }
